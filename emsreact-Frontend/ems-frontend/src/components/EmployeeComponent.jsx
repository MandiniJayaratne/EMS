...
const EmployeeComponent = () => {
  ...
  //initialize variable errors to manage vali errors
  ...
  //updates variables with the retrieved data
  useEffect(() => {
    if (id) {
      getEmployee(id)
        .then((response) => {
  ...
  function saveOrUpdateEmployee(e) {
    ...
    if (validateForm()) {
      ...
      //if id present,then calls updtEmp with id and empoyee obj
      if (id) {
